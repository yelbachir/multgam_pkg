...
- In the R file `install.R`, define the character variable `path2multgam`, which must contain the path to `multgam`. For example, if you extracted `multgam` in your desktop and are using linux, you could use 
```R
